...
const Projects = () => {
  return (
    <div>
      <h1 className='text-3xl text-gray-400 text-center p-4 px-14' style={{ paddingTop: "1rem" }}>Projects</h1>
    <div className='flex flex-wrap p-4'>
      <a href='' target='_blank' className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{width:"230px"}}>
        ...
        <div className="z-10 overflow-hidden pt-2 text-sm font-bold text-gray-500">MERN, Bootstrap</div>
      </a>
      <a href='' target='_blank' className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{width:"230px"}}>
