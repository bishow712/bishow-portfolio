  ...
  return (
    <div>
      ...
      <div className='flex flex-wrap justify-evenly p-4'>
        <a href='https://github.com/bishow712/project-management-application-MERN' target='_blank' rel="noreferrer" className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{ width: "230px" }}>
        ...
        <a href='https://github.com/bishow712/real-time-chat-app-dotnet-redux' target='_blank' rel="noreferrer" className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{ width: "230px" }}>
        ...
        <a href='https://github.com/bishow712/video-chat-webrtc-ts' target='_blank' rel="noreferrer" className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{ width: "230px" }}>
        ...
        <a href='https://bishow712.github.io/github-info-generator/' target='_blank' rel="noreferrer" className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{ width: "230px" }}>
        ...
        <a href='https://weather-app-steel-zeta.vercel.app/' target='_blank' rel="noreferrer" className="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-4 pb-4 pt-40 m-4 hover:scale-110 transition-transform duration-200 ease-in-out" style={{ width: "230px" }}>
